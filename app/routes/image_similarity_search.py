...
def similarity():
    ...
    if request.method == 'POST':
        ...
        if uploaded_file.filename != '':
            ...
            search_results = search_similar_items(query_embedding, index_name_image, 15, 0.012)
    ...
    return render_template('similarity.html', query_results=search_results, query_image=query_image_uri)
